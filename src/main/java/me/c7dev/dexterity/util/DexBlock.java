...
public class DexBlock {
    ...
    public void setTempVector(Vector v) {
        if (tempv != null && v != null) {
            throw new IllegalArgumentException("Illegal concurrent modification to block!");
        }
        tempv = v;
    }
